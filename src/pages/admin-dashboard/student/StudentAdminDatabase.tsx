...
const StudentAdminDatabase: React.FC = () => {
  ...
  const formatStudentData = (data: any): studentDataInterface => {
    return {
      ...
      schoolclass: data.schoolclass || 0,
      ...
      starter_pack_collected: data.starter_pack_collected || null,
    };
  };

  useEffect(() => {
    // studentsIdData && setNewStudentData(studentsIdData.data.data);
    if (studentsIdData && studentsIdData.data && studentsIdData.data.data) {
      // setNewStudentData((prevState) => ({
      //   ...prevState,
      //   ...studentsIdData.data.data,
      //   id: studentsIdData.data.data.id || 0,
      //   last_name: studentsIdData.data.data.last_name || "",
      //   first_name: studentsIdData.data.data.first_name || "",
      //   middle_name: studentsIdData.data.data.middle_name || "",
      //   image: studentsIdData.data.data.image || null,
      //   student_class: studentsIdData.data.data.student_class || "",
      //   schoolclass: studentsIdData.data.data.schoolclass || 0,
      //   date_of_birth: studentsIdData.data.data.date_of_birth
      //     ? new Date(studentsIdData.data.data.date_of_birth)
      //     : null,
      //   gender: studentsIdData.data.data.gender || "",
      //   fathers_name: studentsIdData.data.data.fathers_name || "",
      //   fathers_occupation: studentsIdData.data.data.fathers_occupation || "",
      //   fathers_contact: studentsIdData.data.data.fathers_contact || "",
      //   mothers_name: studentsIdData.data.data.mothers_name || "",
      //   mothers_occupation: studentsIdData.data.data.mothers_occupation || "",
      //   mothers_contact: studentsIdData.data.data.mothers_contact || "",
      //   home_address: studentsIdData.data.data.home_address || "",
      //   guardian_email: studentsIdData.data.data.guardian_email || "",
      //   home_town: studentsIdData.data.data.home_town || "",
      //   state_of_origin: studentsIdData.data.data.state_of_origin || "",
      //   country: studentsIdData.data.data.country || "",
      //   religion: studentsIdData.data.data.religion || "",
      //   starter_pack_collected:
      //     studentsIdData.data.data.starter_pack_collected || null,
      // }));
      setNewStudentData(formatStudentData(studentsIdData.data.data));

      setImageFile(studentsIdData.data.data.image);
    }
    console.log(
